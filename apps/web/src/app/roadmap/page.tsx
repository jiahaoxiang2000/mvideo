...
const roadmapItems: RoadmapItem[] = [
	...
	},
	{
		...
		description:
			'An "Edit with MVideo" badge web apps can integrate. Shows on video players.',
		status: {
			text: "Not started",
			type: "default",
		},
...
export const metadata: Metadata = {
	title: "Roadmap - MVideo",
	description:
		"See what's coming next for MVideo - the free, open-source video editor that respects your privacy.",
	openGraph: {
		title: "MVideo Roadmap - What's Coming Next",
		description:
			"See what's coming next for MVideo - the free, open-source video editor that respects your privacy.",
		type: "website",
		images: [
...
export default function RoadmapPage() {
	return (
		<BasePage
			title="Roadmap"
			description="What's coming next for MVideo (last updated: July 14, 2025)"
		>
			<div className="mx-auto flex max-w-4xl flex-col gap-16">
				...
				<GitHubContributeSection
					title="Want to help?"
					description="MVideo is open source and built by the community. Every contribution,
