...
export const metadata: Metadata = {
	title: "Privacy Policy - MVideo",
	description:
		"Learn how MVideo handles your data and privacy. Our commitment to protecting your information while you edit videos.",
	openGraph: {
		title: "Privacy Policy - MVideo",
		description:
			"Learn how MVideo handles your data and privacy. Our commitment to protecting your information while you edit videos.",
	...
	return (
		...
		>
			...
			<section className="flex flex-col gap-3">
				...
				<p>MVideo integrates with these services:</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					MVideo is completely open source. You can review our code, see
