...
export const metadata: Metadata = {
	title: "Terms of Service - MVideo",
	description:
		"MVideo's Terms of Service. Fair, transparent terms for our free and open-source video editor.",
	openGraph: {
		title: "Terms of Service - MVideo",
		description:
			"MVideo's Terms of Service. Fair, transparent terms for our free and open-source video editor.",
	...
	return (
		...
		>
				...
				>
					...
					<AccordionContent>
						...
						<ol className="list-decimal space-y-2 pl-6">
							...
							<li>Don't use MVideo for illegal activities or harassment</li>
							<li>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					<strong>You own everything you create.</strong> MVideo processes
					...
					projects, or any content you create using MVideo.
				</p>
				<ul className="list-disc space-y-2 pl-6">
					...
					<li>No watermarks, no licensing restrictions from MVideo</li>
				</ul>
			</section>

			<section className="flex flex-col gap-3">
				<h2 className="text-2xl font-semibold">How You Can Use MVideo</h2>
				<p>MVideo is free for personal and commercial use. You can:</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>
						Create videos for personal, educational, or commercial purposes
					</li>
					<li>Use MVideo for client work and paid projects</li>
					<li>Share and distribute videos created with MVideo</li>
					<li>
						Modify and distribute the MVideo software (under MIT license)
					</li>
				</ul>
				<p>
					<strong>What we ask:</strong> Don't use MVideo for illegal
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					MVideo offers optional AI-powered features that require server
					processing:
				</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					MVideo is provided "as is" without warranties. While we strive for
			...
			<section className="flex flex-col gap-3">
				...
				<p>Because MVideo is open source, you have additional rights:</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>Review our code to see exactly how we handle your data</li>
					<li>Self-host MVideo on your own servers</li>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					When using MVideo, make sure you have the right to use any content
					you import:
				</p>
				<ul className="list-disc space-y-2 pl-6">
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					MVideo is provided free of charge. To the extent permitted by law:
				</p>
				<ul className="list-disc space-y-2 pl-6">
			...
			<section className="flex flex-col gap-3">
				...
				<p>We may update MVideo and these terms:</p>
				<ul className="list-disc space-y-2 pl-6">
